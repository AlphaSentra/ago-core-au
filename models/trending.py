...
from _config import EQ_EQUITY_LONG_SHORT_PROMPT, EQ_EQUITY_FACTORS_PROMPT, CR_CRYPTO_LONG_SHORT_PROMPT, CR_CRYPTO_FACTORS_PROMPT, HOLISTIC_MARKET_PROMPT, FX_LONG_SHORT_PROMPT, FX_FACTORS_PROMPT
